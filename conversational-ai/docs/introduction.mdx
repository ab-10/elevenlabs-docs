...
<Frame>
  ![Conversational AI Platform](/conversational-ai/images/convai.png)
</Frame>
...
<CardGroup cols={2}>
 ...
 Get to production in hours, not months. Our platform handles the complex infrastructure including speech processing, turn-taking, and conversation management.
    ...
    <Frame>
          ![Playground](/conversational-ai/images/playground.png)
    </Frame>
  ...
  <Card title="Premium Voice Quality" icon="waveform">
    ...
    ![Voices](/conversational-ai/images/voices.png)
...
<CardGroup cols={2}>
  <Card title="Product UI" icon="desktop">
    **500 credits per minute** 
    <>
    
        - Access through our web interface
        - Easy no-code intergation with any website
  ...
  <Card title="API Access" icon="code">
    **1,000 credits per minute** 
     <>

      - Direct Websocket API integration
      - Full programmatic control
      - Customizable agent permissions
